      ...
      <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="relative z-10">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6 leading-tight">
            Wir unterstützen Unternehmen weltweit dabei, KI als festen Bestandteil ihrer Prozesse und Abläufe zu etablieren.
          </h3>
          <p className="text-slate-600 text-lg leading-relaxed mb-6">
            Wir verbinden tiefes Prozessverständnis, strategisches Denken und modernste KI-Technologie. 
            In den nächsten fünf Jahren entscheidet KI, welche Unternehmen wachsen und welche den Anschluss verlieren.
          </p>
          <ul className="space-y-4">
            {['KI in Kernprozessen integriert', 'Daten- und wissensbasierte Entscheidungen', 'Steigerung der Produktivität pro Mitarbeiter', 'Unternehmen besitzen und kontrollieren ihre Systeme'].map((item, i) => (
           ...
           <div className="bg-slate-900 rounded-2xl p-8 relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 text-white space-y-6">
                <div className="flex justify-between items-end border-b border-white/10 pb-4">
                  <div>
                    <div className="text-white/60 text-sm mb-1">Effizienzsteigerung</div>
                ...
                <div className="flex justify-between items-end border-b border-white/10 pb-4">
                  <div>
                    <div className="text-white/60 text-sm mb-1">ROI (Durchschnitt)</div>
                    <div className="text-3xl font-bold text-brand-primary">6-12 Mon.</div>
                  </div>
                </div>
              </div>
           </div>
