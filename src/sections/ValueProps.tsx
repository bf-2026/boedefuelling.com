...
const features = [
  {
    ...
    description: "Zentrale Nutzung von Unternehmenswissen für effektiven Wissenstransfer und Vermeidung von Informationssilos."
  },
  {
    icon: ShieldCheck,
    title: "Verlässliche Entscheidungen",
    description: "Verlässliche, kontextbezogene Entscheidungen auf Basis ihrer eigenen Unternehmensdaten."
  },
  {
    icon: Zap,
    title: "Schnelligkeit",
    description: "Schnellere Entscheidungen in allen Bereichen durch sofort verfügbares Expertenwissen."
  },
  {
    icon: BarChart3, // Using existing icon for now, could import more if needed
    title: "Prozess-Eliminierung",
    description: "Eliminierung von manuellen Prozessen und signifikante Entlastung ihrer Teams."
  },
  {
    icon: ShieldCheck,
    title: "Datensouveränität",
    description: "Volle Datenhoheit, Compliance und Sicherheit für ihre sensiblen Unternehmensinformationen."
  }
];
